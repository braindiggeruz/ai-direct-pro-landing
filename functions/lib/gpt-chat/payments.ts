// Legacy provider scaffold retained for old callers/tests. Consumer UZS
// billing is now implemented in billing-config/store and /payments/click,
// /payments/payme. This module is not an authority for paid access.
//
...
export type PaymentProvider =
  "lemonsqueezy" | "paddle" | "globalpay" | "freedompay" | "";
