  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-2">
        <a href="https://t.me/XGame_changerx" onClick={() => { track(EV.leadIntent, { from: 'b2b_card', where: 'discuss' }); track(EV.telegramClick, { from: 'b2b_card' }); }} rel="nofollow noopener noreferrer" target="_blank" className="btn-primary text-[13px] px-4 py-2.5 min-h-12">
          {t.b2bDiscuss}
        </a>
