...
<header class="border-b border-white/5 bg-bg-base/80 backdrop-blur sticky top-0 z-40">
  <div class="max-w-5xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
    ...
    <nav class="flex gap-3 text-sm items-center">
      ...
      <a href="${escapeHtml(a.cta?.href || global.defaultCTA.href)}" data-testid="header-cta" rel="nofollow noopener noreferrer" target="_blank" class="bg-grad-cta text-bg-base font-semibold px-4 py-2 rounded-full">
...
<main id="main" class="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
  ...
  ${a.cta ? `<div class="mt-12 mb-4"><a data-testid="article-cta-end" href="${escapeHtml(a.cta.href)}" rel="nofollow noopener noreferrer" target="_blank" class="inline-flex items-center justify-center bg-grad-cta text-bg-base font-semibold px-8 py-4 rounded-full shadow-glow">${escapeHtml(a.cta.label)}</a></div>` : ''}
  ${renderFaq(a.faq || [], a)}
