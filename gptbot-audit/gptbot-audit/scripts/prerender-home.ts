...
<div data-seo-shell="homepage" data-testid="seo-shell">
  ...
  <main>
    ...
    <p><a href="${escapeHtml(cta.href)}" rel="noopener noreferrer" target="_blank">${escapeText(cta.label)}</a></p>
  ...
  <footer>
    ...
    <p><a href="${escapeHtml(global.telegram || '#')}" rel="noopener noreferrer" target="_blank">Telegram</a></p>
  </footer>
</div>`;
}
