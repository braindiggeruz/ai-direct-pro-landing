...
if (!current || current.id !== oldDeploymentId || current.latest_stage?.status !== 'success'
...
if (manifest.artifactSha256 !== oldArtifact) throw new Error('apex artifact changed during verification');
