...
const copy = {
  ru: {
    ...
    photosLater: 'Фото пока добавляются через бота — загрузка из кабинета готовится.',
  ...
  uz: {
    ...
    photosLater: 'Suratlar hozircha bot orqali qo‘shiladi — kabinetdan yuklash tayyorlanmoqda.',
