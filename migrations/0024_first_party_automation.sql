-- GPTBot first-party automation runtime.
--
-- D1 is the orchestration source of truth. Queue messages contain only
-- bounded references to these rows; generated content stays in domain tables.

CREATE TABLE IF NOT EXISTS automation_jobs (
  job_id             TEXT PRIMARY KEY,
  job_type           TEXT NOT NULL
    CHECK (job_type IN ('seo_draft_generation')),
