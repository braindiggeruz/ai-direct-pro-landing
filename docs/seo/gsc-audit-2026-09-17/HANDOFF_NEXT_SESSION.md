...
7. **Расширенный план** — `ROADMAP_EXTENDED_2026-09-18.md` (X01–X22): узбекские коммерческие хабы, Google Business Profile, конверсионный путь и события GA4, alt/CWV/IndexNow; календарь и список того, что нужно от владельца, — в разделах 4–5 того файла.
