  ...
  return (
    <footer id="contacts" data-testid="site-footer" className="relative pt-16 pb-32 sm:pb-12 border-t border-white/5 bg-bg-base/40">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-12 gap-8 md:gap-10">
          ...
          <div className="col-span-2 md:col-span-4">
            <div className="flex items-center gap-3 mb-4">
              <span className="relative inline-flex h-9 w-9 items-center justify-center rounded-xl bg-grad-cta">
                <img src="/assets/landing/logo-sq.webp" alt="Логотип GPTBot" className="h-7 w-7 rounded-lg" width={28} height={28} loading="lazy" />
              </span>
              <div>
          ...
          <div className="md:col-span-2" data-testid="footer-resources">
            ...
            <ul className="space-y-2.5 text-sm mb-6">
              ...
              <li><a href={isUz ? '/uz/boss-digital/' : '/boss-digital/'} data-testid="footer-boss-digital" className="text-white/65 hover:text-brand-cyan transition">Boss Digital</a></li>
        ...
        <div className="mt-12 pt-6 border-t border-white/5 flex flex-col sm:flex-row gap-2 items-start sm:items-center justify-between text-xs text-white/60">
