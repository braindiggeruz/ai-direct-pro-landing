...
// Static CSS gradient: it preserves the visual wash without repainting a
// full-screen blurred layer for the lifetime of the page.
...
function GradientBackground({ className, ...props }: GradientBackgroundProps) {
  return (
    <div
      ...
      className={cn(
        'size-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500',
        className,
      )}
      {...props}
    />
