...
const RU: ChatStrings = {
  premium: {
    ...
    historyNote:'История хранится только в этом браузере, отдельно для гостя и каждого аккаунта. Между устройствами она не синхронизируется.',savedChats:'Ваши разговоры',noHistory:'Сохранённых разговоров пока нет.',newChatHint:'Начать новую тему',actionCost:'В Plus завершённый ответ на продолжение, перевод или упрощение использует один ответ лимита. Прерванные и неуспешные ответы в этот лимит не входят.',
  },
  brand: 'GPTBot AI',
  online: 'Online',
...
const UZ: ChatStrings = {
  premium: {
    ...
    historyNote:'Tarix faqat shu brauzerda, mehmon va har bir akkaunt uchun alohida saqlanadi. Qurilmalar orasida sinxronlanmaydi.',savedChats:'Suhbatlaringiz',noHistory:'Hozircha saqlangan suhbat yo‘q.',newChatHint:'Yangi mavzu boshlash',actionCost:'Plus’da davom ettirish, tarjima yoki soddalashtirishga tugallangan javob limitdan bitta javob sarflaydi. Uzilgan yoki xato bilan tugagan javoblar bu limitga kirmaydi.',
  },
  brand: 'GPTBot AI',
  online: 'Online',
