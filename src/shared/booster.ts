...
export const CLUSTERS: ClusterDef[] = [
  { id: 'ai-bot-business',   label: 'AI/GPT bot for business',  money: { ru: ['/ru/ai-bot-dlya-biznesa/', '/ru/gpt-dlya-biznesa/', '/ru/chat-bot-dlya-biznesa/'], uz: ['/uz/biznes-uchun-ai-bot/', '/uz/gpt-bot-biznes-uchun/'] }, head: '/ru/ai-bot-dlya-biznesa/' },
  ...
  { id: 'lead-processing',   label: 'Lead processing automation', money: { ru: ['/ru/avtomatizatsiya-zayavok/', '/ru/ai-prodavec/'], uz: ['/uz/arizalarni-avtomatlashtirish/'] }, head: '/ru/avtomatizatsiya-zayavok/' },
